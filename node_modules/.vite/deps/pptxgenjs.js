...
function encodeSlideMediaRels(layout) {
  ...
  const loadNodeDeps = isNode ? () => __awaiter(this, void 0, void 0, function* () {
    ({ default: fs } = yield import("./node_fs-ZYLUKG4J.js"));
    ({ default: https } = yield import("./node_https-DDZLTDPX.js"));
...
var PptxGenJS = class {
  ...
  writeFile(props) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (isNode) {
        const { promises: fs } = yield import("./node_fs-ZYLUKG4J.js");
        const { writeFile } = fs;
